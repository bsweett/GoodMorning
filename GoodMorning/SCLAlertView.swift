...
class SCLAlertView: UIViewController {
    ...
    // Font
    let kDefaultFont = "Avenir-Medium"
	let kButtonFont = "Avenir-Heavy"
    ...
    func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: SCLAlertViewStyle) -> SCLAlertViewResponder {
        ...
        switch style {
			...
			case .Notice:
				viewColor = gmYellowColor //UIColorFromRGB(0x727375)
			...
			case .Info:
				viewColor = gmYellowColor //UIColorFromRGB(0x2866BF)
				iconImage = SCLAlertViewStyleKit.imageOfInfo
            
			case .Edit:
				viewColor = gmYellowColor //UIColorFromRGB(0xA429FF)
